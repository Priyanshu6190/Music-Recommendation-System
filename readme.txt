...
|---------------|--------------|---------------------|
| HTML, CSS, JS | Flask (Python) | Scikit-learn (Random Forest) |
| Custom Audio Player | YouTube Integration (yt_dlp) | LabelEncoder, Pandas |
...
2. Training:
   - Train a `RandomForestClassifier` on audio features.
   - Save the model and label encoder as `.pkl`.
...
📬 Contact
Your Name – priyanshu619rana@gmail.com

Project Link: https://github.com/Priyanshu6190/Music-Recommendation System